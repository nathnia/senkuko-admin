...
class ProductService {
  ...
  static Future<http.Response> getProducts() => _safe(
        http.get(Uri.parse(ApiConstants.products),
            headers: ApiConstants.headers),
      );

  static Future<http.Response> getProductById(String id) => _safe(
        http.get(Uri.parse('${ApiConstants.baseUrl}/products/$id'),
            headers: ApiConstants.headers),
      );
  ...
  static Future<http.Response> deleteProduct(String productId) {
    ...
    return _safe(
      http.delete(Uri.parse(url), headers: ApiConstants.headers),
    );
  }

  // ===================== VARIANTS =====================
  static Future<http.Response> getAllVariants() => _safe(
        http.get(Uri.parse('${ApiConstants.baseUrl}/product-variants'),
            headers: ApiConstants.headers),
      );
  ...
  static Future<http.Response> getVariants(String productId) => _safe(
        http.get(
            Uri.parse(
                '${ApiConstants.baseUrl}/products/$productId/variants'),
            headers: ApiConstants.headers),
      );
  ...
  static Future<http.Response> getPrices() => _safe(
        http.get(Uri.parse(ApiConstants.productPrices),
            headers: ApiConstants.headers),
      );
  ...
  static Future<http.Response> getPricesByVariant(String variantId) => _safe(
        http.get(
            Uri.parse(
                '${ApiConstants.baseUrl}/product-prices/variant/$variantId'),
            headers: ApiConstants.headers),
      );
  ...
  static Future<http.Response> getUnits() => _safe(
        http.get(Uri.parse('${ApiConstants.baseUrl}/units'),
            headers: ApiConstants.headers),
      );
  ...
  static Future<http.Response> deleteUnit(String id) => _safe(
        http.delete(Uri.parse('${ApiConstants.baseUrl}/units/$id'),
            headers: ApiConstants.headers),
      );

  // ===================== CATEGORIES =====================
  static Future<http.Response> getCategories() => _safe(
        http.get(Uri.parse('${ApiConstants.baseUrl}/categories'),
            headers: ApiConstants.headers),
      );
  ...
  static Future<http.Response> deleteCategory(String id) => _safe(
        http.delete(Uri.parse('${ApiConstants.baseUrl}/categories/$id'),
            headers: ApiConstants.headers),
      );

  // ===================== PRICE LISTS =====================
  static Future<http.Response> getPriceLists() => _safe(
        http.get(Uri.parse('${ApiConstants.baseUrl}/price-lists'),
            headers: ApiConstants.headers),
      );
  ...
  static Future<http.Response> uploadProductImage({
    ...
    try {
      ...
      return http.Response(
        jsonEncode(
            {'success': false, 'message': 'Upload timeout, coba lagi'}),
        408,
      );
    } catch (e) {
      return http.Response(
  ...
  static Future<http.Response> deleteProductImage(
      ...
      _safe(
        http.delete(
            Uri.parse(
                '${ApiConstants.baseUrl}/products/$productId/images/$imageId'),
            headers: ApiConstants.headers),
      );
}